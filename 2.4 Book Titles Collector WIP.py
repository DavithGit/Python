...
Create a Sorted List: Once all titles are collected, save them to a new list named books_sorted. 
...
def main():
    ...
    while i < 10:
        booktitle =input("Please enter a book title with proper capitalization: ")
        booktitle.title
        booklist.append(booktitle)
        i=i+1
    else:
        books_sorted = booklist.sort
